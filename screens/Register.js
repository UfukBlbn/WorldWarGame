...
const checkPasswordStrength = (password) => {
  ...
  if (password.length < 10) return 'Orta';
...
class Register extends React.Component {
  ...
  handlePasswordChange = (password) => {
    ...
    this.setState({ password, strength: checkPasswordStrength(password) });
  };
                ...
                <Block flex center>
                  ...
                  >
                    ...
                    <Block width={width * 0.8}>
                      ...
                      />
                      {this.state.showPasswordStrength && (<Block row style={styles.passwordCheck}>
                        <Text size={12} color={argonTheme.COLORS.MUTED}>
                          Şifre gücü:
                        </Text>
                        <Text bold size={12} color={this.getStrengthColor()}>
                          {" "}
